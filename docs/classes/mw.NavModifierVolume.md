[玩法](../groups/玩法.玩法.md) / NavModifierVolume
...
| **[areaClass](mw.NavModifierVolume.md#areaclass)**(): [`NavModifierType`](../enums/mw.NavModifierType.md)   |
| :-----|
| 获取区域类型|
...
| [`NavModifierType`](../enums/mw.NavModifierType.md) | 当前区域类型 |
| :------ | :------ |
...
| `type` [`NavModifierType`](../enums/mw.NavModifierType.md) |  新区域类型 |
| :------ | :------ |
