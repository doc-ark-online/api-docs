...
| Accessors |
| :-----|
| **[areaClass](mw.NavModifierVolume.md#areaclass)**(): [`AreaClass`](../enums/mw.AreaClass.md) <br> 获取区域类型|
...
• `get` **areaClass**(): [`AreaClass`](../enums/mw.AreaClass.md)

获取区域类型

#### Returns

[`AreaClass`](../enums/mw.AreaClass.md)
...
| Name | Type |
| :------ | :------ |
| `areaClass` | [`AreaClass`](../enums/mw.AreaClass.md) |
