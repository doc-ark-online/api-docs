[auto-mwapi-lib](../README.md) / [Exports](../modules.md) / [Gameplay](../modules/Gameplay.md) / [Gameplay](../modules/Gameplay.Gameplay.md) / Interactor

# Class: Interactor

[Gameplay](../modules/Gameplay.md).[Gameplay](../modules/Gameplay.Gameplay.md).Interactor
...
- [constructor](Gameplay.Gameplay.Interactor.md#constructor)

### Properties

- [onInteractiveEnter](Gameplay.Gameplay.Interactor.md#oninteractiveenter)
- [onInteractiveExit](Gameplay.Gameplay.Interactor.md#oninteractiveexit)
- [serverSetShowDebugLog](Gameplay.Gameplay.Interactor.md#serversetshowdebuglog)

### Accessors

- [forwardVector](Gameplay.Gameplay.Interactor.md#forwardvector)
- [guid](Gameplay.Gameplay.Interactor.md#guid)
- [isVisible](Gameplay.Gameplay.Interactor.md#isvisible)
- [lockState](Gameplay.Gameplay.Interactor.md#lockstate)
- [name](Gameplay.Gameplay.Interactor.md#name)
- [netStatus](Gameplay.Gameplay.Interactor.md#netstatus)
- [parent](Gameplay.Gameplay.Interactor.md#parent)
- [relativeLocation](Gameplay.Gameplay.Interactor.md#relativelocation)
- [relativeRotation](Gameplay.Gameplay.Interactor.md#relativerotation)
- [relativeScale](Gameplay.Gameplay.Interactor.md#relativescale)
- [rightVector](Gameplay.Gameplay.Interactor.md#rightvector)
- [staticStatus](Gameplay.Gameplay.Interactor.md#staticstatus)
- [tag](Gameplay.Gameplay.Interactor.md#tag)
- [transform](Gameplay.Gameplay.Interactor.md#transform)
- [upVector](Gameplay.Gameplay.Interactor.md#upvector)
- [useUpdate](Gameplay.Gameplay.Interactor.md#useupdate)
- [worldLocation](Gameplay.Gameplay.Interactor.md#worldlocation)
- [worldRotation](Gameplay.Gameplay.Interactor.md#worldrotation)
- [worldScale](Gameplay.Gameplay.Interactor.md#worldscale)

### Methods

- [addDestroyCallback](Gameplay.Gameplay.Interactor.md#adddestroycallback)
- [asyncGetScriptByName](Gameplay.Gameplay.Interactor.md#asyncgetscriptbyname)
- [attachToGameObject](Gameplay.Gameplay.Interactor.md#attachtogameobject)
- [clone](Gameplay.Gameplay.Interactor.md#clone)
- [convertStringToStanceGuid](Gameplay.Gameplay.Interactor.md#convertstringtostanceguid)
- [deleteDestroyCallback](Gameplay.Gameplay.Interactor.md#deletedestroycallback)
- [destroy](Gameplay.Gameplay.Interactor.md#destroy)
- [detachFromGameObject](Gameplay.Gameplay.Interactor.md#detachfromgameobject)
- [enterInteractiveState](Gameplay.Gameplay.Interactor.md#enterinteractivestate)
- [exitInteractiveState](Gameplay.Gameplay.Interactor.md#exitinteractivestate)
- [getBoundingBoxSize](Gameplay.Gameplay.Interactor.md#getboundingboxsize)
- [getBounds](Gameplay.Gameplay.Interactor.md#getbounds)
- [getChildByGuid](Gameplay.Gameplay.Interactor.md#getchildbyguid)
- [getChildByName](Gameplay.Gameplay.Interactor.md#getchildbyname)
- [getChildren](Gameplay.Gameplay.Interactor.md#getchildren)
- [getChildrenBoxCenter](Gameplay.Gameplay.Interactor.md#getchildrenboxcenter)
- [getCollision](Gameplay.Gameplay.Interactor.md#getcollision)
- [getForwardVector](Gameplay.Gameplay.Interactor.md#getforwardvector)
- [getInteractiveState](Gameplay.Gameplay.Interactor.md#getinteractivestate)
- [getRelativeLocation](Gameplay.Gameplay.Interactor.md#getrelativelocation)
- [getRelativeRotation](Gameplay.Gameplay.Interactor.md#getrelativerotation)
- [getRelativeScale](Gameplay.Gameplay.Interactor.md#getrelativescale)
- [getRightVector](Gameplay.Gameplay.Interactor.md#getrightvector)
- [getScriptByGuid](Gameplay.Gameplay.Interactor.md#getscriptbyguid)
- [getScriptByName](Gameplay.Gameplay.Interactor.md#getscriptbyname)
- [getScripts](Gameplay.Gameplay.Interactor.md#getscripts)
- [getSourceAssetGuid](Gameplay.Gameplay.Interactor.md#getsourceassetguid)
- [getTransform](Gameplay.Gameplay.Interactor.md#gettransform)
- [getUpVector](Gameplay.Gameplay.Interactor.md#getupvector)
- [getWorldLocation](Gameplay.Gameplay.Interactor.md#getworldlocation)
- [getWorldRotation](Gameplay.Gameplay.Interactor.md#getworldrotation)
- [getWorldScale](Gameplay.Gameplay.Interactor.md#getworldscale)
- [interactiveChara](Gameplay.Gameplay.Interactor.md#interactivechara)
- [isRunningClient](Gameplay.Gameplay.Interactor.md#isrunningclient)
- [onDestroy](Gameplay.Gameplay.Interactor.md#ondestroy)
- [onStart](Gameplay.Gameplay.Interactor.md#onstart)
- [onUpdate](Gameplay.Gameplay.Interactor.md#onupdate)
- [ready](Gameplay.Gameplay.Interactor.md#ready)
- [setCollision](Gameplay.Gameplay.Interactor.md#setcollision)
- [setLocationAndRotation](Gameplay.Gameplay.Interactor.md#setlocationandrotation)
- [setRelativeLocation](Gameplay.Gameplay.Interactor.md#setrelativelocation)
- [setRelativeRotation](Gameplay.Gameplay.Interactor.md#setrelativerotation)
- [setRelativeScale](Gameplay.Gameplay.Interactor.md#setrelativescale)
- [setTransform](Gameplay.Gameplay.Interactor.md#settransform)
- [setVisibility](Gameplay.Gameplay.Interactor.md#setvisibility)
- [setWorldLocation](Gameplay.Gameplay.Interactor.md#setworldlocation)
- [setWorldRotation](Gameplay.Gameplay.Interactor.md#setworldrotation)
- [setWorldScale](Gameplay.Gameplay.Interactor.md#setworldscale)
- [asyncFind](Gameplay.Gameplay.Interactor.md#asyncfind)
- [asyncSpawnGameObject](Gameplay.Gameplay.Interactor.md#asyncspawngameobject)
- [find](Gameplay.Gameplay.Interactor.md#find)
- [findGameObjectByTag](Gameplay.Gameplay.Interactor.md#findgameobjectbytag)
- [getGameObjectByName](Gameplay.Gameplay.Interactor.md#getgameobjectbyname)
- [getGameObjectsByName](Gameplay.Gameplay.Interactor.md#getgameobjectsbyname)
- [spawnGameObject](Gameplay.Gameplay.Interactor.md#spawngameobject)
...
• **onInteractiveEnter**: [`Delegate`](Type.Type.Delegate.md)<(`result`: `boolean`) => `void`\>
...
Gameplay/index.d.ts:11035

---

### onInteractiveExit

• **onInteractiveExit**: [`Delegate`](Type.Type.Delegate.md)<(`result`: `boolean`) => `void`\>
...
| Name     | Type     | Description          |
| :------- | :------- | :------------------- |
| `stance` | `string` | usage: 姿态 default: |
...
▸ **enterInteractiveState**(`charaObj`): `Promise`<`boolean`\>
...
| Name       | Type                                    | Description                    |
| :--------- | :-------------------------------------- | :----------------------------- |
| `charaObj` | [`GameObject`](Core.Core.GameObject.md) | usage: 激活交互的角色 default: |
...
| Name       | Type                            | Description                                |
| :--------- | :------------------------------ | :----------------------------------------- |
| `Location` | [`Vector`](Type.Type.Vector.md) | usage: 退出交互的位置                      |
| `stance?`  | `string`                        | usage: 退出交互物的姿态 default: undefined |
...
▸ **interactiveChara**(): [`Character`](Gameplay.Gameplay.Character.md)
