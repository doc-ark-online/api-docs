...
| **[onBufferRedoUndoPrivate](mw.DrawBoard.md#onbufferredoundoprivate)**: `any`  |
| :-----|
| 撤销恢复回调事件|
| **[onGlobalTouchEndPrivate](mw.DrawBoard.md#onglobaltouchendprivate)**: `any`  |
| 全局触摸抬起事件|
...
### onBufferRedoUndoPrivate <Score text="onBufferRedoUndoPrivate" /> 

▪ `Static` `Private` **onBufferRedoUndoPrivate**: `any`

撤销恢复回调事件

___

### onGlobalTouchEndPrivate <Score text="onGlobalTouchEndPrivate" /> 

▪ `Static` `Private` **onGlobalTouchEndPrivate**: `any`
