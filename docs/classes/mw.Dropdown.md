...
| 移除菜单项|
| **[setIsOpen](mw.Dropdown.md#setisopen)**(`bOpen`: `boolean`): `void` <Badge type="tip" text="client" />  |
| 设置下拉菜单打开/关闭|
...
### setIsOpen <Score text="setIsOpen" /> 

• **setIsOpen**(`bOpen`): `void` <Badge type="tip" text="client" />
