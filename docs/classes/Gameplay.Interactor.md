[Avatar](../groups/Avatar.Avatar.md) / Interactor
...
| Methods |
| :-----|
| **[convertStringToStanceGuid](Gameplay.Interactor.md#convertstringtostanceguid)**(`stance`: `string`): `string` <br> 将姿态转换为GUID|
