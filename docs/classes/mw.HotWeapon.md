...
| `maxShootRange` `number` |  最大射程  <br> default: 100  <br> range:[0,100000]<br> type:浮点数 |
| :------ | :------ |
...
| :------ | :------ |
| `ShootRange` `number` |  最大射程  <br> default: 100  <br> range:[0, 100000]<br> type:浮点数 |
...
| `bulletSize` `number` |  子弹数  <br> range:[1, ClipSize]<br> type: 整数 |
| :------ | :------ |
