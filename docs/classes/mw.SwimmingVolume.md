...
<p class="content-big"> 游泳区域 </p>

<p class="content-big"> ---------------------------------- </p>

<p class="content-big"> 拖入 SwimmingVolume 调整游泳区域的大小，角色进入游泳区域会切换成游泳状态。 </p>

<p style="font-size: 14px;"> 使用示例:请放置在场景中，通过动态查找获取。不支持动态生成，可重叠使用。 </p>
