...
| Properties |
| :-----|
| **[onEnter](mw.SwimmingVolume.md#onenter)**: [`MulticastGameObjectDelegate`](mw.MulticastGameObjectDelegate.md) <br> 进入游泳区域事件|
| **[onLeave](mw.SwimmingVolume.md#onleave)**: [`MulticastGameObjectDelegate`](mw.MulticastGameObjectDelegate.md) <br> 离开游泳区域事件|
...
| Accessors |
| :-----|
| **[fluidFriction](mw.SwimmingVolume.md#fluidfriction)**(): `number` <br> 获取流体摩擦力|
