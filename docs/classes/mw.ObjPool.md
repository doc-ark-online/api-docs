[Utility](../groups/Core.Utility.md) / ObjPool
        ...
        AssetUtil.asyncDownloadAsset(cubeAssetId).then(() => {
            ...
            InputUtil.onKeyDown(Keys.F, () => {
                ...
                setTimeout(() => {
                    ...
                    cube.obj.worldLocation = new Vector(0, 0, 0);
                }, 5000);
            });
...
//将对象池中的已回收对象全部销毁
    ...
    private onCubeReset(cube: Cube): void {
        let playerPos = getCurrentPlayer().character.worldLocation;
...
class Cube {
    ...
    public obj: GameObject = null;

    constructor() {
        this.obj = GameObject.spawn({ guid: "7669" });
    }
}
```
...
| Accessors |
| :-----|
| **[size](mw.ObjPool.md#size)**(): `number` <br> 获取对象池中空闲对象的数量|

| Methods |
| :-----|
| **[clear](mw.ObjPool.md#clear)**(): `void` <br> 清除池中对象|
| **[despawn](mw.ObjPool.md#despawn)**(`obj`: `T`): `void` <br> 归还一个对象|
| **[spawn](mw.ObjPool.md#spawn)**(): `T` <br> 生成一个对象|
