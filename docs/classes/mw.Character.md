...
| **[onTouch](mw.Character.md#ontouch)**: [`MulticastDelegate`](mw.MulticastDelegate.md)<(`velocities`: [`Vector`](mw.Vector.md)[], `hitActors`: [`GameObject`](mw.GameObject.md)[], `impactPoints`: [`Vector`](mw.Vector.md)[], `impactNormals`: [`Vector`](mw.Vector.md)[]) => `void`\>  |
| 角色开启强制位移后，输出移动中碰撞检测结果中新增的接触物体。|
| **[onTouchEnd](mw.Character.md#ontouchend)**: [`MulticastDelegate`](mw.MulticastDelegate.md)<(`velocities`: [`Vector`](mw.Vector.md)[], `hitActors`: [`GameObject`](mw.GameObject.md)[], `impactPoints`: [`Vector`](mw.Vector.md)[], `impactNormals`: [`Vector`](mw.Vector.md)[]) => `void`\>  |
| 角色开启强制位移后，输出移动中碰撞检测结果中已停止的接触物体。|

### Accessors <Score text="Accessors" /> 
| **[CastShadow](mw.Character.md#castshadow)**(): `boolean`   |
| :-----|
| 角色阴影开关|
...
| 获取角色碰撞形状（胶囊体型、球型、盒型）。角色碰撞盒形状的大小，决定角色与场景对象交互时检测碰撞范围的大小。|
...
| 强制更新移动|
| **[frequencyScaleSound](mw.Character.md#frequencyscalesound)**(): `number`   |
| 获取玩家音效音量|
...
| **[jumpingSound](mw.Character.md#jumpingsound)**(): `string`   |
| 获取跳跃音效|
| **[landingSound](mw.Character.md#landingsound)**(): `string`   |
| 获取着陆音效|
...
| **[runningSound](mw.Character.md#runningsound)**(): `string`   |
| 获取跑步音效|
| **[splashSound](mw.Character.md#splashsound)**(): `string`   |
| 获取水花音效|
| **[swimmingSound](mw.Character.md#swimmingsound)**(): `string`   |
| 获取游泳音效|
...
| 为角色加载一个二级姿态|
| **[pauseCharacterSound](mw.Character.md#pausecharactersound)**(): `void` <Badge type="tip" text="other" />  |
| 关闭音效播放开关|
| **[playCharacterSound](mw.Character.md#playcharactersound)**(): `void` <Badge type="tip" text="other" />  |
| 打开音效播放开关|
...
• **onTouch**: [`MulticastDelegate`](mw.MulticastDelegate.md)<(`velocities`: [`Vector`](mw.Vector.md)[], `hitActors`: [`GameObject`](mw.GameObject.md)[], `impactPoints`: [`Vector`](mw.Vector.md)[], `impactNormals`: [`Vector`](mw.Vector.md)[]) => `void`\>
...
• **onTouchEnd**: [`MulticastDelegate`](mw.MulticastDelegate.md)<(`velocities`: [`Vector`](mw.Vector.md)[], `hitActors`: [`GameObject`](mw.GameObject.md)[], `impactPoints`: [`Vector`](mw.Vector.md)[], `impactNormals`: [`Vector`](mw.Vector.md)[]) => `void`\>
...
角色当前开启阴影投射。true表示打开，false表示关闭。

:::

#### Parameters

| `value` `boolean` |  true为打开阴影投射，false为禁用。 |
| :------ | :------ |
...
### frequencyScaleSound <Score text="frequencyScaleSound" /> 
...
• `set` **frequencyScaleSound**(`value`): `void` <Badge type="tip" text="other" />
...
### jumpingSound <Score text="jumpingSound" /> 
...
• `set` **jumpingSound**(`sound`): `void` <Badge type="tip" text="other" />
...
### landingSound <Score text="landingSound" /> 
...
• `set` **landingSound**(`sound`): `void` <Badge type="tip" text="other" />
...
### runningSound <Score text="runningSound" /> 
...
• `set` **runningSound**(`sound`): `void` <Badge type="tip" text="other" />
...
### splashSound <Score text="splashSound" /> 
...
• `set` **splashSound**(`sound`): `void` <Badge type="tip" text="other" />
...
### swimmingSound <Score text="swimmingSound" /> 
...
• `set` **swimmingSound**(`sound`): `void` <Badge type="tip" text="other" />
...
### pauseCharacterSound <Score text="pauseCharacterSound" /> 

• **pauseCharacterSound**(): `void` <Badge type="tip" text="other" />
...
### playCharacterSound <Score text="playCharacterSound" /> 

• **playCharacterSound**(): `void` <Badge type="tip" text="other" />
