...
![角色](https://cdn.233xyx.com/online/LDCaIRtlrFhf1701341963723.png)
...
| `value` `boolean` |  true表示角色可以移动，false表示角色不可移动。 |
| :------ | :------ |
...
| [`MovementMode`](../enums/mw.MovementMode.md) | 当前角色移动模式 |
| :------ | :------ |
