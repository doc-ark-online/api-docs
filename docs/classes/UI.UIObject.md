...
| Accessors |
| :-----|
| **[uiBehaviour](UI.UIObject.md#uibehaviour)**(): [`UIBehavior`](UI.UIBehavior.md) <br> 得到UI脚本|
| **[uiPath](UI.UIObject.md#uipath)**(): `string` <br> 返回ui文件的路径|
| **[uiWidgetBase](UI.UIObject.md#uiwidgetbase)**(): [`UserWidget`](UI.UserWidget.md) <br> 获取该对象下所绑定的UI控件的集合|
...
### uiBehaviour <Score text="uiBehaviour" /> 

• `get` **uiBehaviour**(): [`UIBehavior`](UI.UIBehavior.md) <Badge type="tip" text="other" />
...
• `get` **uiPath**(): `string` <Badge type="tip" text="other" />
