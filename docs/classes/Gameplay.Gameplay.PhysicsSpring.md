...
- [isVisible](Gameplay.Gameplay.PhysicsSpring.md#isvisible)
- [limitedLengthstate](Gameplay.Gameplay.PhysicsSpring.md#limitedlengthstate)
- [lockState](Gameplay.Gameplay.PhysicsSpring.md#lockstate)
...
• `get` **limitedLengthstate**(): `boolean`
...
Gameplay/index.d.ts:12891

• `set` **limitedLengthstate**(`LimitedLengthstate`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `LimitedLengthstate` | `boolean` | usage:限定状态 |
