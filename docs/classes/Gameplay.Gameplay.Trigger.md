[auto-mwapi-lib](../README.md) / [Exports](../modules.md) / [Gameplay](../modules/Gameplay.md) / [Gameplay](../modules/Gameplay.Gameplay.md) / Trigger

# Class: Trigger

[Gameplay](../modules/Gameplay.md).[Gameplay](../modules/Gameplay.Gameplay.md).Trigger
...
- [constructor](Gameplay.Gameplay.Trigger.md#constructor)

### Properties

- [onEnter](Gameplay.Gameplay.Trigger.md#onenter)
- [onLeave](Gameplay.Gameplay.Trigger.md#onleave)

### Accessors

- [forwardVector](Gameplay.Gameplay.Trigger.md#forwardvector)
- [guid](Gameplay.Gameplay.Trigger.md#guid)
- [isVisible](Gameplay.Gameplay.Trigger.md#isvisible)
- [lockState](Gameplay.Gameplay.Trigger.md#lockstate)
- [name](Gameplay.Gameplay.Trigger.md#name)
- [netStatus](Gameplay.Gameplay.Trigger.md#netstatus)
- [parent](Gameplay.Gameplay.Trigger.md#parent)
- [relativeLocation](Gameplay.Gameplay.Trigger.md#relativelocation)
- [relativeRotation](Gameplay.Gameplay.Trigger.md#relativerotation)
- [relativeScale](Gameplay.Gameplay.Trigger.md#relativescale)
- [rightVector](Gameplay.Gameplay.Trigger.md#rightvector)
- [staticStatus](Gameplay.Gameplay.Trigger.md#staticstatus)
- [tag](Gameplay.Gameplay.Trigger.md#tag)
- [transform](Gameplay.Gameplay.Trigger.md#transform)
- [upVector](Gameplay.Gameplay.Trigger.md#upvector)
- [useUpdate](Gameplay.Gameplay.Trigger.md#useupdate)
- [worldLocation](Gameplay.Gameplay.Trigger.md#worldlocation)
- [worldRotation](Gameplay.Gameplay.Trigger.md#worldrotation)
- [worldScale](Gameplay.Gameplay.Trigger.md#worldscale)

### Methods

- [addDestroyCallback](Gameplay.Gameplay.Trigger.md#adddestroycallback)
- [asyncGetScriptByName](Gameplay.Gameplay.Trigger.md#asyncgetscriptbyname)
- [attachToGameObject](Gameplay.Gameplay.Trigger.md#attachtogameobject)
- [clone](Gameplay.Gameplay.Trigger.md#clone)
- [deleteDestroyCallback](Gameplay.Gameplay.Trigger.md#deletedestroycallback)
- [destroy](Gameplay.Gameplay.Trigger.md#destroy)
- [detachFromGameObject](Gameplay.Gameplay.Trigger.md#detachfromgameobject)
- [getBoundingBoxSize](Gameplay.Gameplay.Trigger.md#getboundingboxsize)
- [getBounds](Gameplay.Gameplay.Trigger.md#getbounds)
- [getChildByGuid](Gameplay.Gameplay.Trigger.md#getchildbyguid)
- [getChildByName](Gameplay.Gameplay.Trigger.md#getchildbyname)
- [getChildren](Gameplay.Gameplay.Trigger.md#getchildren)
- [getChildrenBoxCenter](Gameplay.Gameplay.Trigger.md#getchildrenboxcenter)
- [getCollision](Gameplay.Gameplay.Trigger.md#getcollision)
- [getForwardVector](Gameplay.Gameplay.Trigger.md#getforwardvector)
- [getRelativeLocation](Gameplay.Gameplay.Trigger.md#getrelativelocation)
- [getRelativeRotation](Gameplay.Gameplay.Trigger.md#getrelativerotation)
- [getRelativeScale](Gameplay.Gameplay.Trigger.md#getrelativescale)
- [getRightVector](Gameplay.Gameplay.Trigger.md#getrightvector)
- [getScriptByGuid](Gameplay.Gameplay.Trigger.md#getscriptbyguid)
- [getScriptByName](Gameplay.Gameplay.Trigger.md#getscriptbyname)
- [getScripts](Gameplay.Gameplay.Trigger.md#getscripts)
- [getSourceAssetGuid](Gameplay.Gameplay.Trigger.md#getsourceassetguid)
- [getTransform](Gameplay.Gameplay.Trigger.md#gettransform)
- [getUpVector](Gameplay.Gameplay.Trigger.md#getupvector)
- [getWorldLocation](Gameplay.Gameplay.Trigger.md#getworldlocation)
- [getWorldRotation](Gameplay.Gameplay.Trigger.md#getworldrotation)
- [getWorldScale](Gameplay.Gameplay.Trigger.md#getworldscale)
- [inArea](Gameplay.Gameplay.Trigger.md#inarea)
- [isBoxShape](Gameplay.Gameplay.Trigger.md#isboxshape)
- [isRunningClient](Gameplay.Gameplay.Trigger.md#isrunningclient)
- [isSphereShape](Gameplay.Gameplay.Trigger.md#issphereshape)
- [onDestroy](Gameplay.Gameplay.Trigger.md#ondestroy)
- [onStart](Gameplay.Gameplay.Trigger.md#onstart)
- [onUpdate](Gameplay.Gameplay.Trigger.md#onupdate)
- [ready](Gameplay.Gameplay.Trigger.md#ready)
- [setBoxExtent](Gameplay.Gameplay.Trigger.md#setboxextent)
- [setCollision](Gameplay.Gameplay.Trigger.md#setcollision)
- [setCollisionEnabled](Gameplay.Gameplay.Trigger.md#setcollisionenabled)
- [setLocationAndRotation](Gameplay.Gameplay.Trigger.md#setlocationandrotation)
- [setRelativeLocation](Gameplay.Gameplay.Trigger.md#setrelativelocation)
- [setRelativeRotation](Gameplay.Gameplay.Trigger.md#setrelativerotation)
- [setRelativeScale](Gameplay.Gameplay.Trigger.md#setrelativescale)
- [setSphereRadius](Gameplay.Gameplay.Trigger.md#setsphereradius)
- [setTransform](Gameplay.Gameplay.Trigger.md#settransform)
- [setVisibility](Gameplay.Gameplay.Trigger.md#setvisibility)
- [setWorldLocation](Gameplay.Gameplay.Trigger.md#setworldlocation)
- [setWorldRotation](Gameplay.Gameplay.Trigger.md#setworldrotation)
- [setWorldScale](Gameplay.Gameplay.Trigger.md#setworldscale)
- [toggleTriggerShape](Gameplay.Gameplay.Trigger.md#toggletriggershape)
- [asyncFind](Gameplay.Gameplay.Trigger.md#asyncfind)
- [asyncSpawnGameObject](Gameplay.Gameplay.Trigger.md#asyncspawngameobject)
- [find](Gameplay.Gameplay.Trigger.md#find)
- [findGameObjectByTag](Gameplay.Gameplay.Trigger.md#findgameobjectbytag)
- [getGameObjectByName](Gameplay.Gameplay.Trigger.md#getgameobjectbyname)
- [getGameObjectsByName](Gameplay.Gameplay.Trigger.md#getgameobjectsbyname)
- [spawnGameObject](Gameplay.Gameplay.Trigger.md#spawngameobject)
...
| Name         | Type                                    | Description            |
| :----------- | :-------------------------------------- | :--------------------- |
| `gameObject` | [`GameObject`](Core.Core.GameObject.md) | usage:传入需判断的对象 |
...
▸ **setBoxExtent**(`InBoxExent`, `updateOverlaps?`): `void`
...
| Name              | Type                            | Description                 |
| :---------------- | :------------------------------ | :-------------------------- |
| `InBoxExent`      | [`Vector`](Type.Type.Vector.md) | usage:盒体长宽高            |
| `updateOverlaps?` | `boolean`                       | usage:是否刷新 default:true |
...
| Name              | Type      | Description                 |
| :---------------- | :-------- | :-------------------------- |
| `InSphereRadius`  | `number`  | usage:球体半径              |
| `updateOverlaps?` | `boolean` | usage:是否刷新 default:true |
