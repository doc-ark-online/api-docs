...
- [enableHideByDistance](Gameplay.Gameplay.UIWidget.md#enablehidebydistance)
- [enableOcclusion](Gameplay.Gameplay.UIWidget.md#enableocclusion)
- [enableScaledByDistance](Gameplay.Gameplay.UIWidget.md#enablescaledbydistance)
...
- [isVisible](Gameplay.Gameplay.UIWidget.md#isvisible)
- [lockState](Gameplay.Gameplay.UIWidget.md#lockstate)
- [name](Gameplay.Gameplay.UIWidget.md#name)
- [netStatus](Gameplay.Gameplay.UIWidget.md#netstatus)
- [occluedByItself](Gameplay.Gameplay.UIWidget.md#occluedbyitself)
...
- [getInteraction](Gameplay.Gameplay.UIWidget.md#getinteraction)
...
- [setInteraction](Gameplay.Gameplay.UIWidget.md#setinteraction)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `newSize` | [`Vector2`](Type.Type.Vector2.md) | usage:渲染大小2D |
...
Gameplay/index.d.ts:10246

___

### enableHideByDistance

• `get` **enableHideByDistance**(): `boolean`
...
Gameplay/index.d.ts:10311

• `set` **enableHideByDistance**(`Value`): `void`
...
Gameplay/index.d.ts:10316

___

### enableOcclusion

• `get` **enableOcclusion**(): `boolean`
...
Gameplay/index.d.ts:10291

• `set` **enableOcclusion**(`Value`): `void`
...
Gameplay/index.d.ts:10296

___

### enableScaledByDistance

• `get` **enableScaledByDistance**(): `boolean`
...
Gameplay/index.d.ts:10301

• `set` **enableScaledByDistance**(`Value`): `void`
...
Gameplay/index.d.ts:10331

• `set` **occluedByItself**(`Value`): `void`
...
▸ **setInteraction**(`inInteraction`): `boolean`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `uiUserWidget` | [`UserWidget`](UI.UI.UserWidget.md) | usage:UI对象 |
