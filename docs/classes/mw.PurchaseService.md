...
| **[getInstance](mw.PurchaseService.md#getinstance)**(): [`PurchaseService`](mw.PurchaseService.md) <br> 获取应用内购管理器全局实例|

## Accessors

### onArkBalanceUpdated <Score text="onArkBalanceUpdated" /> 

• `get` **onArkBalanceUpdated**(): [`MulticastDelegate`](mw.MulticastDelegate.md)<[`OnArkBalanceUpdated`](../modules/Core.mw.md#onarkbalanceupdated)\> <Badge type="tip" text="client" />
...
• `get` **onOrderDelivered**(): [`MulticastDelegate`](mw.MulticastDelegate.md)<[`OnOrderDelivered`](../modules/Core.mw.md#onorderdelivered)\> <Badge type="tip" text="server" />
...
• `get` **onPremiumMemberOrderDelivered**(): [`MulticastDelegate`](mw.MulticastDelegate.md)<[`OnKeyConsume`](../modules/Core.mw.md#onkeyconsume)\> <Badge type="tip" text="server" />
...
• `get` **onPremiumMemberStatusUpdate**(): [`MulticastDelegate`](mw.MulticastDelegate.md)<(`result`: `boolean`) => `void`\> <Badge type="tip" text="client" />
...
if (Util.SystemUtil.isServer()) {
     console.log("监听发货");
     //发货监听
     PurchaseService.getInstance().onPremiumMemberOrderDelivered.add((
...
// 扣除钥匙
PurchaseService.getInstance().consumeKey("1000", 1, 1, (status : consumeKeyStatus) => {
...
使用示例:将代码片段放入脚本中即可
```ts
PurchaseService.getInstance().findKeyUsageHistory(1, 100, (total : number, currentPage : number, bills : keyUsageInfo[]) => {
...
• `Static` **getInstance**(): [`PurchaseService`](mw.PurchaseService.md) 
...
[`PurchaseService`](mw.PurchaseService.md)
