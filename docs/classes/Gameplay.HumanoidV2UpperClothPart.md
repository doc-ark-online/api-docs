[Gameplay](../modules/Gameplay.Gameplay.md) / HumanoidV2UpperClothPart
...
| Methods |
| :-----|
| **[getUpperClothClothColor](Gameplay.HumanoidV2UpperClothPart.md#getupperclothclothcolor)**(`number`): [`LinearColor`](Type.LinearColor.md) <br> 获取颜色|
| **[setUpperClothClothColor](Gameplay.HumanoidV2UpperClothPart.md#setupperclothclothcolor)**(`number`, [`LinearColor`](Type.LinearColor.md), `boolean`): `void` <br> 设置颜色|
...
• **getUpperClothClothColor**(`areaIndex`): [`LinearColor`](Type.LinearColor.md) <Badge type="tip" text="other" />
...
• **setUpperClothClothColor**(`index`, `color`, `sync`): `void` <Badge type="tip" text="other" />
