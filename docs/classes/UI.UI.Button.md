...
| **[cachedGeometry](UI.UI.Button.md#cachedgeometry)**(): [`Geometry`](UI.UI.Geometry.md) <br> 获取上一次的 GetTickSpaceGeometry                             |
...
| **[disableImageGuid](UI.UI.Button.md#disableimageguid)**(): `string` <br> 获取禁用图片 ID                                                                  |
...
| **[guid](UI.UI.Button.md#guid)**(): `string` <br> 获取控件 GUID                                                                                            |
| **[isHovered](UI.UI.Button.md#ishovered)**(): `boolean` <br> 是否是 hovered                                                                                |
...
| **[normalImageGuid](UI.UI.Button.md#normalimageguid)**(): `string` <br> 获取普通图片 ID                                                                    |
...
| **[paintSpaceGeometry](UI.UI.Button.md#paintspacegeometry)**(): [`Geometry`](UI.UI.Geometry.md) <br> 获取最后一次用于渲染 Widget 的几何信息                |
...
| **[setPressedImageColorDecimal](UI.UI.Button.md#setpressedimagecolordecimal)**(`number`, `number`, `number`, `number`): `void` <br> 设置按下颜色指定 R、G、B、A 设置颜色 0 ~255               |
