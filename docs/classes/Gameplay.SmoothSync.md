...
• `get` **positionSnapThreshold**(): `number` <Badge type="tip" text="other" />
...
• `set` **positionSnapThreshold**(`value`): `void` <Badge type="tip" text="other" />
...
• `get` **rotationSnapThreshold**(): `number` <Badge type="tip" text="other" />
...
• `get` **scaleSnapThreshold**(): `number` <Badge type="tip" text="other" />
...
• `set` **timeSmoothing**(`value`): `void` <Badge type="tip" text="other" />
