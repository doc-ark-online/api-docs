...
| `inHexString` `string` | Hex颜色字符串<br> range: 符合 Hex 特点的字符串类型 |
| :------ | :------ |
...
| `R` `number` | 字体颜色 R 值。  <br> range:[0, 255]<br> type: 整数 |
| :------ | :------ |
| `G` `number` | 字体颜色 G 值。  <br> range:[0, 255]<br> type: 整数 |
| `B` `number` | 字体颜色 B 值。  <br> range:[0, 255]<br> type: 整数 |
| `A` `number` | 字体颜色 透明度。  <br> range:[0, 255]<br> type: 整数 |
...
| `inHexString` `string` | 十六进制的字符串<br> range: 符合 Hex 特点的字符串类型 |
| :------ | :------ |
...
| `inHexString` `string` | 颜色<br> range: 符合 Hex 特点的字符串类型 |
| :------ | :------ |
...
| `R` `number` | 阴影颜色 R 值。  <br> range:[0, 255]<br> type: 整数 |
| :------ | :------ |
| `G` `number` | 阴影颜色 G 值。  <br> range:[0, 255]<br> type: 整数 |
| `B` `number` | 阴影颜色 B 值。  <br> range:[0, 255]<br> type: 整数 |
| `A` `number` | 阴影颜色 透明度。  <br> range:[0, 255]<br> type: 整数 |
