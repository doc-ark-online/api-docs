...
| :-----|
| 是否按下|
| **[setButtonDisableByFile](mw.Button.md#setbuttondisablebyfile)**(`absPath`: `string`): `void` <Badge type="tip" text="client" />  |
| 设置不可用图片|
| **[setButtonNormalByFile](mw.Button.md#setbuttonnormalbyfile)**(`absPath`: `string`): `void` <Badge type="tip" text="client" />  |
| 设置正常图片|
| **[setButtonPressedByFile](mw.Button.md#setbuttonpressedbyfile)**(`absPath`: `string`): `void` <Badge type="tip" text="client" />  |
| 设置按下图片|
