...
- [lockStatus](Gameplay.Gameplay.PhysicsImpulse.md#lockstatus)
...
- [visible](Gameplay.Gameplay.PhysicsImpulse.md#visible)
...
- [getVisibility](Gameplay.Gameplay.PhysicsImpulse.md#getvisibility)
