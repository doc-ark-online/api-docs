[Gui](../groups/Gui.Gui.md) / GuiManager
...
| **[showUI](UI.UIManager.md#showui)**(`panel`: [`UIBehavior`](UI.UIBehavior.md), `layer?`: `number`, `...params`: `any`[]): [`UIBehavior`](UI.UIBehavior.md) <br> 显示一个界面,会把界面添加到界面上，从原有父节点移除|
