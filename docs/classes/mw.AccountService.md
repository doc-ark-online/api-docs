...
| :-----|
| 发起添加好友请求|
| **[checkSharedId](mw.AccountService.md#checksharedid)**(`id`: `string`, `callback`: [`AvatarCheckResponse`](../modules/Core.mw.md#avatarcheckresponse)): `void` <Badge type="tip" text="client" />  |
| 检查分享Id的角色数据|
...
| 设置数据是否公开给其他用户|
| **[downloadData](mw.AccountService.md#downloaddata)**(`character`: [`Character`](mw.Character.md), `callback?`: [`AvatarCheckResponse`](../modules/Core.mw.md#avatarcheckresponse), `index?`: `number`): `void` <Badge type="tip" text="client" />  |
| 下载角色形象并应用到当前角色身上|
...
| **[setUserData](mw.AccountService.md#setuserdata)**(`character`: [`Character`](mw.Character.md), `dataString`: `string`, `callback?`: [`AvatarCheckResponse`](../modules/Core.mw.md#avatarcheckresponse)): `void` <Badge type="tip" text="client" />  |
| 将角色形象数据应用至角色|
...
| **[useCacheOrDownloadData](mw.AccountService.md#usecacheordownloaddata)**(`character`: [`Character`](mw.Character.md), `callback?`: [`BoolResponse`](../modules/Core.mw.md#boolresponse)  [`VoidResponse`](../modules/Core.mw.md#voidresponse), `index?`: `number`): `void` <Badge type="tip" text="client" />  |
...
### checkSharedId <Score text="checkSharedId" /> 

• `Static` **checkSharedId**(`id`, `callback`): `void` <Badge type="tip" text="client" />
...
| :------ | :------ |
| `callback` [`AvatarCheckResponse`](../modules/Core.mw.md#avatarcheckresponse) |  回调参数，true:应用成功；false:应用失败 |
...
| :------ | :------ |
| `callback?` [`AvatarCheckResponse`](../modules/Core.mw.md#avatarcheckresponse) | 设置是否成功的回调 default:默认没有回调 |
| `index?` `number` | 角色资源位 default:0（主角资源位） range: [0,5] type: 整形 |
...
| `callback?` [`AvatarCheckResponse`](../modules/Core.mw.md#avatarcheckresponse) | 设置是否成功的回调 default:无回调 |
