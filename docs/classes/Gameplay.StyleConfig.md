[Avatar](../groups/Avatar.Avatar.md) / StyleConfig
...
| :------ | :------ | :------ |
| `base?` | `{ `characterSetting?`: { `switchCharacter?`: [`CharacterTemplate`](../enums/Gameplay.CharacterTemplate.md) ; `switchSomatotype?`: [`SomatotypeV2`](../enums/Gameplay.SomatotypeV2.md)  }`  } | **`Description`** 基础 |
| `base.characterSetting?` | `{ `switchCharacter?`: [`CharacterTemplate`](../enums/Gameplay.CharacterTemplate.md) ; `switchSomatotype?`: [`SomatotypeV2`](../enums/Gameplay.SomatotypeV2.md)  }` | **`Description`** 角色设定 |
| `base.characterSetting.switchCharacter?` | [`CharacterTemplate`](../enums/Gameplay.CharacterTemplate.md) | **`Description`** 切换角色,配置中优先执行 |
| `base.characterSetting.switchSomatotype?` | [`SomatotypeV2`](../enums/Gameplay.SomatotypeV2.md) | **`Description`** 切换体型 |
