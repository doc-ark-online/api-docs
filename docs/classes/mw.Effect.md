...
| Properties |
| :-----|
| **[onFinish](mw.Effect.md#onfinish)**: [`MulticastDelegate`](mw.MulticastDelegate.md)<() => `void`\> <br> 特效播放完毕事件|
...
| Accessors |
| :-----|
| **[loopCount](mw.Effect.md#loopcount)**(): `number` <br> 获取特效循环次数，仅对非永久循环特效有效|
