...
| Accessors |
| :-----|
| **[serverCalculateEnable](Gameplay.Humanoid.md#servercalculateenable)**(`boolean`): `void` <br> 开/关 npc的功能,现包含(角色的网络同步，角色移动)未来可能会添加其他计算|
...
• **ondestroy**(): `void` <Badge type="tip" text="other" />
