...
<p class="content-big"> 禁行区 </p>

<p class="content-big"> ---------------------------------- </p>

<p class="content-big"> 用于控制角色是否可以进出此区域。 </p>
...
<p style="font-size: 14px;"> 使用示例:请尽量放置在场景中，通过动态查找获取。不推荐动态生成，不支持重叠使用。 </p>
...
| **[addPassableTarget](mw.BlockingVolume.md#addpassabletarget)**(`target`: [`GameObject`](mw.GameObject.md)): `void`  |
| :-----|
| 为目标添加通过该区域的权限|
| **[clear](mw.BlockingVolume.md#clear)**(): `void`  |
| 重置禁行区|
| **[getTargetPassable](mw.BlockingVolume.md#gettargetpassable)**(`target`: [`GameObject`](mw.GameObject.md)): `boolean`  |
| 获得目标通过该区域的权限|
| **[removePassableTarget](mw.BlockingVolume.md#removepassabletarget)**(`target`: [`GameObject`](mw.GameObject.md)): `void`  |
| 移除目标通过该区域的权限|
| **[unblockAll](mw.BlockingVolume.md#unblockall)**(): `void`  |
| 开放禁行区|
...
<p style="font-size: 14px;"> 使用示例: 针对此禁行区为其他GameObject添加通行许可 </p>
...
<p style="font-size: 14px;"> 使用示例: 重置该禁行区发布的所有通行许可 </p>
...
<p style="font-size: 14px;"> 使用示例: 获取此禁行区对某GameObject的通行许可 </p>
...
<p style="font-size: 14px;"> 使用示例: 针对此禁行区为其他GameObject移除通行许可 </p>
...
<p style="font-size: 14px;"> 使用示例: 开放该禁行区 </p>
