[Gameplay](../modules/Gameplay.Gameplay.md) / NavModifierVolume
...
| Accessors |
| :-----|
| **[areaClass](Gameplay.NavModifierVolume.md#areaclass)**(): [`AreaClass`](../enums/Gameplay.AreaClass.md) <br> 获取区域类型|
