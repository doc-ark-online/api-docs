...
| `obj` `T` |  要创建补间的对象类型 |
| :------ | :------ |
| `group?` ``false``  [`TweenGroup`](mw.TweenGroup.md) |  要创建的补间对象的分组  <br> default:  mainGroup |
...
| `amount?` `number` |  延迟时间，单位：ms。  <br> default:  0  <br> range: [0, +∞]<br> type: 浮点数 |
| :------ | :------ |
...
| `d?` `number` |  完成补间需要的时间，单位：ms。  <br> default:  1000  <br> range: [0, +∞]<br> type: 浮点数 |
| :------ | :------ |
...
| `easingFunction?` [`TweenEasingFunction`](../modules/Core.mw.md#tweeneasingfunction) |  缓动函数  <br> default:  Easing.Linear.None |
| :------ | :------ |
...
| `group?` [`TweenGroup`](mw.TweenGroup.md) |  新的分组  <br> default:  mainGroup |
| :------ | :------ |
...
| `interpolationFunction?` [`TweenInterpolationFunction`](../modules/Core.mw.md#tweeninterpolationfunction) |  插值函数  <br> default:  Interpolation.Linear |
| :------ | :------ |
...
| `callback?` (`object`: `T`) => `void` |  要绑定的回调函数  <br> default:  undefined |
| :------ | :------ |
...
| `callback?` (`object`: `T`, `elapsed`: `number`) => `void` |  要绑定的回调函数  <br> default:  undefined |
| :------ | :------ |
...
| `time?` `number` |  暂停生效时间  <br> default:  当前时间  <br> range: [0, +∞]<br> type: 浮点数 |
| :------ | :------ |
...
| `times?` `number` |  重复次数  <br> default:  0  <br> range: [0, +∞]<br> type: 浮点数 |
| :------ | :------ |
...
| `amount?` `number` |  延迟时间，单位：ms。  <br> default:  undefined<br> type: 浮点数<br> range: [0, +∞] |
| :------ | :------ |
...
| `time?` `number` |  恢复生效时间  <br> default:  当前时间  <br> range: [0, +∞]<br> type: 浮点数 |
| :------ | :------ |
...
| `time?` `number` |  启动生效时间  <br> default:  当前时间  <br> range: [0, +∞]<br> type: 浮点数 |
| :------ | :------ |
...
| :------ | :------ |
| `duration?` `number` |  完成补间需要的时间，单位：ms。  <br> default:  1000  <br> range: [0, +∞]<br> type: 浮点数 |
...
| `time?` `number` |  要绑定的回调函数  <br> default:  当前时间  <br> range: [0, +∞]<br> type: 浮点数 |
| :------ | :------ |
| `autoStart?` `boolean` |  是否自动开始  <br> default:  true |
...
| `yoyo?` `boolean` |  是否启用yoyo  <br> default:  false |
| :------ | :------ |
