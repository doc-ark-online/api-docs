...
| Name | Type | Description |
| :------ | :------ | :------ |
| `inDriver` | [`Player`](Gameplay.Gameplay.Player.md) | usage: 驾驶员的Player |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `newInput` | `number` | usage: 转向幅度，取值范围[-1,1]，大于0时右转，小于0则左转。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `newInput` | `number` | usage: 油门大小，取值范围[-1,1]，大于0时加速，小于0则减速。 |
