...
- [isVisible](Gameplay.Gameplay.BlockingArea.md#isvisible)
- [lockState](Gameplay.Gameplay.BlockingArea.md#lockstate)
...
- [getPlayerStateResponse](Gameplay.Gameplay.BlockingArea.md#getplayerstateresponse)
...
▸ **getPlayerStateResponse**(): `unknown`
