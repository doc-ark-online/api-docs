...
| :-----|
| 服务器监听客户端发来的事件|
| **[addGameEventListener](mw.Event.md#addgameeventlistener)**(`eventName`: `string`, `callback`: (`data`: `string`) => `void`): `void`  |
| 注册游戏级的事件|
...
| 添加本地事件。|
| **[addSceneEventListener](mw.Event.md#addsceneeventlistener)**(`eventName`: `string`, `callback`: (`data`: `string`) => `void`): `void`  |
...
| 客户端监听服务器事件|
| **[dispatchGameEvent](mw.Event.md#dispatchgameevent)**(`eventName`: `string`, `data`: `string`): `void`  |
| 广播游戏级的事件，在同一个游戏中的不同房间，都可以收到该事件广播|
| **[dispatchSceneEvent](mw.Event.md#dispatchsceneevent)**(`eventName`: `string`, `data`: `string`): `void`  |
