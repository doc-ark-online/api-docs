[auto-mwapi-lib](../README.md) / [Exports](../modules.md) / [Gameplay](../modules/Gameplay.md) / [Gameplay](../modules/Gameplay.Gameplay.md) / HotWeaponSlotOld
...
bool型变量，true代表目前插槽已装备配件，false反之
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `IsEquipAccessory` | `boolean` | usage: bool变量，表示当前插槽是否装备有配件，true代表装备中，false代表未装备 default: undefined |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `accessory` | [`GameObject`](Core.Core.GameObject.md) | usage: 要Attach的ts层热武器配件类 default: undefined |
