...
| `R` `number` | 文本 R 值。  <br> range:[0, 255]<br> type: 整数 |
| :------ | :------ |
| `G` `number` | 文本 G 值。  <br> range:[0, 255]<br> type: 整数 |
| `B` `number` | 文本 B 值。  <br> range:[0, 255]<br> type: 整数 |
| `A` `number` | 文本 透明度。  <br> range:[0, 255]<br> type: 整数 |
...
| `R` `number` | 阴影 R 值。  <br> range:[0, 255]<br> type: 整数 |
| :------ | :------ |
| `G` `number` | 阴影 G 值。  <br> range:[0, 255]<br> type: 整数 |
| `B` `number` | 阴影 B 值。  <br> range:[0, 255]<br> type: 整数 |
| `A` `number` | 阴影 透明度。  <br> range:[0, 255]<br> type: 整数 |
