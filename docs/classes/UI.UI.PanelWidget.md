...
| **[cachedGeometry](UI.UI.PanelWidget.md#cachedgeometry)**(): [`Geometry`](UI.UI.Geometry.md) <br> 获取上一次的 GetTickSpaceGeometry                    |
...
| **[guid](UI.UI.PanelWidget.md#guid)**(): `string` <br> 获取控件 GUID                                                                                   |
| **[isHovered](UI.UI.PanelWidget.md#ishovered)**(): `boolean` <br> 是否是 hovered                                                                       |
| **[name](UI.UI.PanelWidget.md#name)**(): `string` <br> 获取名字                                                                                        |
| **[paintSpaceGeometry](UI.UI.PanelWidget.md#paintspacegeometry)**(): [`Geometry`](UI.UI.Geometry.md) <br> 获取最后一次用于渲染 Widget 的几何信息       |
...
| **[tickSpaceGeometry](UI.UI.PanelWidget.md#tickspacegeometry)**(): [`Geometry`](UI.UI.Geometry.md) <br> 获取最后一次用于驱动 Widget Tick 的几何信息    |
...
| **[zOrder](UI.UI.PanelWidget.md#zorder)**(): `number` <br> 获取 zorder                                                                                 |
