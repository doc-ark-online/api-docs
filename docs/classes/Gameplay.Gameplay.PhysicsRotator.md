...
| **[guid](Gameplay.Gameplay.PhysicsRotator.md#guid)**(): `string` <br> 获取对象的guid（唯一标识一个对象的字符串）。|
...
| **[maxRotationalAngularVelocity](Gameplay.Gameplay.PhysicsRotator.md#maxrotationalangularvelocity)**(): `number` <br> 最大旋转角速度Get|
...
| **[rotationalAngularAcceleration](Gameplay.Gameplay.PhysicsRotator.md#rotationalangularacceleration)**(): `number` <br> 旋转角加速度Get|
| **[rotationalAngularVelocity](Gameplay.Gameplay.PhysicsRotator.md#rotationalangularvelocity)**(): `number` <br> 旋转角速度Get|
| **[staticStatus](Gameplay.Gameplay.PhysicsRotator.md#staticstatus)**(): `boolean` <br> 获取对象是否静态|
| **[tag](Gameplay.Gameplay.PhysicsRotator.md#tag)**(): `string` <br> 获取当前物体的Tag|
| **[transform](Gameplay.Gameplay.PhysicsRotator.md#transform)**(): [`Transform`](Type.Type.Transform.md) <br> 返回当前物体transform|
...
| **[visible](Gameplay.Gameplay.PhysicsRotator.md#visible)**(): `boolean` <br> since:v0.20.0 reason:api重构 replacement:getVisibility()|
...
| Methods |
| :-----|
| **[addDestroyCallback](Gameplay.Gameplay.PhysicsRotator.md#adddestroycallback)**((...`arg`: `unknown`[]) => `void`): `void` <br> 添加物体Destroy事件回调|
...
| **[deleteDestroyCallback](Gameplay.Gameplay.PhysicsRotator.md#deletedestroycallback)**((...`arg`: `unknown`[]) => `void`): `void` <br> 移除物体Destroy事件回调|
...
| **[getBounds](Gameplay.Gameplay.PhysicsRotator.md#getbounds)**(`boolean`, [`Vector`](Type.Type.Vector.md), [`Vector`](Type.Type.Vector.md), `boolean`): `void` <br> 获取GameObject边界|
| **[getChildByGuid](Gameplay.Gameplay.PhysicsRotator.md#getchildbyguid)**(`string`): `GameObject` <br> 根据Guid查找子物体|
| **[getChildByName](Gameplay.Gameplay.PhysicsRotator.md#getchildbyname)**(`string`): `GameObject` <br> 根据名称查找子物体|
| **[getChildren](Gameplay.Gameplay.PhysicsRotator.md#getchildren)**(): `GameObject`[] <br> 获取Children，客户端不维系父子关系。推荐使用Find替代|
...
| **[getConstraintTargetGUID](Gameplay.Gameplay.PhysicsRotator.md#getconstrainttargetguid)**(): `string` <br> 获取约束对象GUID|
...
| **[getScriptByGuid](Gameplay.Gameplay.PhysicsRotator.md#getscriptbyguid)**(`string`): `Script` <br> 获得当前物体下的指定脚本 客户端不维系父子关系 推荐使用Find替代|
| **[getScriptByName](Gameplay.Gameplay.PhysicsRotator.md#getscriptbyname)**(`string`): `Script` <br> 获得当前物体下的指定脚本 客户端不维系父子关系 推荐使用Find替代|
| **[getScripts](Gameplay.Gameplay.PhysicsRotator.md#getscripts)**(): `Script`[] <br> 获得当前物体下的所有脚本 客户端不维系父子关系 推荐使用Find替代|
| **[getSourceAssetGuid](Gameplay.Gameplay.PhysicsRotator.md#getsourceassetguid)**(): `string` <br> 获取当前物体使用资源的GUID|
| **[getTransform](Gameplay.Gameplay.PhysicsRotator.md#gettransform)**([`Transform`](Type.Type.Transform.md)): [`Transform`](Type.Type.Transform.md) <br> 返回当前物体Transform|
...
| **[getVisibility](Gameplay.Gameplay.PhysicsRotator.md#getvisibility)**(): `boolean` <br> 获取GameObject是否被显示|
...
| **[onUpdate](Gameplay.Gameplay.PhysicsRotator.md#onupdate)**(`number`): `void` <br> 周期函数 useUpdate 设置为 true 后,每帧被执行,设置为false,不会执行|
| **[ready](Gameplay.Gameplay.PhysicsRotator.md#ready)**(): `Promise`<[`PhysicsRotator`](Gameplay.Gameplay.PhysicsRotator.md)\> <br> GameObject准备好后返回|
| **[reverse](Gameplay.Gameplay.PhysicsRotator.md#reverse)**(): `void` <br> 激活旋转轴非物理旋转，此时会触发OnRotationRun代理|
...
| **[setConstraintTargetByGUID](Gameplay.Gameplay.PhysicsRotator.md#setconstrainttargetbyguid)**(`string`): `void` <br> 设置约束对象GUID|
...
| **[setTransform](Gameplay.Gameplay.PhysicsRotator.md#settransform)**([`Transform`](Type.Type.Transform.md)): `void` <br> 设置当前物体transform|
| **[setVisibility](Gameplay.Gameplay.PhysicsRotator.md#setvisibility)**([`PropertyStatus`](../enums/Type.Type.PropertyStatus.md), `boolean`): `void` <br> 设置GameObject是否被显示|
...
| **[stop](Gameplay.Gameplay.PhysicsRotator.md#stop)**(): `void` <br> 停止旋转轴非物理旋转，此时会触发OnRotationStop代理|
| **[asyncFind](Gameplay.Gameplay.PhysicsRotator.md#asyncfind)**(`string`): `Promise`<`GameObject`\> <br> 通过guid异步查找GameObject,默认是五秒,可以通过 `core.setGlobalAsyncOverTime(5000);|
...
| **[find](Gameplay.Gameplay.PhysicsRotator.md#find)**(`string`): `GameObject` <br> 通过Guid查找GameObject|
| **[findGameObjectByTag](Gameplay.Gameplay.PhysicsRotator.md#findgameobjectbytag)**(`string`): `GameObject`[] <br> 通过自定义Tag获取GameObject|
