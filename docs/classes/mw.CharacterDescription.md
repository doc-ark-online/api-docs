...
| `base.characterSetting.faceStyle` [`FaceStyle`](../enums/mw.FaceStyle.md) | **`Deprecated`** info:该接口已废弃，在该接口被删除前会仍保持可用，请尽快使用替换方案以免出现问题 since:033 reason:功能迁移 replacement: 换头功能 **`Description`** 基础脸型 |
