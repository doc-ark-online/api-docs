...
| **[isUnderLocation](Gui.Gui.md#isunderlocation)**(`geometry`: [`Geometry`](../classes/mw.Geometry.md), `absolutePosition`: [`Vector2`](../classes/mw.Vector2.md)): `boolean` <br> 判定给定坐标是否在geometry下|
