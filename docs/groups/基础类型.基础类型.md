...
| [AvatarCheckStatusCode](../enums/mw.AvatarCheckStatusCode.md) <br> GameService的错误回调编码枚举 |
...
| [MultiTextureFormat](../enums/mw.MultiTextureFormat.md) <br> 贴图格式 |
...
| Interfaces |
| :-----|
| [AvatarBaseError](../interfaces/mw.AvatarBaseError.md) <br> GameService的回调参数类型 |
