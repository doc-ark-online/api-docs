...
| Type Aliases |
| :-----|
| **[maskWordCheckResult](mw.StringUtil.md#maskwordcheckresult)**: `Object` <br> 屏蔽字检测的结果|
...
| **[maskWordCheck](mw.StringUtil.md#maskwordcheck)**(`text`: `string`): `Promise`<[`[maskWordCheck](mw.StringUtil.md#maskwordcheck)Result`](mw.StringUtil.md#maskwordcheckresult)\> <br> 屏蔽字检测|
