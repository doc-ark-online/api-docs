...
| 音效衰减形状|
| [AvatarCheckStatusCode](../enums/mw.AvatarCheckStatusCode.md)  |
...
| 角色状态|
| [MultiTextureFormat](../enums/mw.MultiTextureFormat.md)  |
| 贴图格式|
...
| [AvatarBaseError](../interfaces/mw.AvatarBaseError.md)  |
| :-----|
| GameService的回调参数类型|
| [CameraShakeInfo](../interfaces/mw.CameraShakeInfo.md)  |
| 抖动数据|
| [CloneInfo](../interfaces/mw.CloneInfo.md)  |
| 构建物体的信息|
...
| **[AvatarCheckResponse](Core.mw.md#avatarcheckresponse)**: (`isSuccess`: `boolean`, `errors`: ([`AvatarBaseError`](../interfaces/mw.AvatarBaseError.md)  [`AvatarBaseError`](../interfaces/mw.AvatarBaseError.md) & `{ `assetId`: `string`  }`)[]) => `void`  |
| :-----|
| GameService的回调参数类型|
...
### AvatarCheckResponse <Score text="AvatarCheckResponse" /> 

Ƭ **AvatarCheckResponse**: (`isSuccess`: `boolean`, `errors`: ([`AvatarBaseError`](../interfaces/mw.AvatarBaseError.md)  [`AvatarBaseError`](../interfaces/mw.AvatarBaseError.md) & `{ `assetId`: `string`  }`)[]) => `void`

#### Type declaration

• (`isSuccess`, `errors`): `void`
...
| `isSuccess` | `boolean` |
| :------ | :------ |
| `errors` | ([`AvatarBaseError`](../interfaces/mw.AvatarBaseError.md)  [`AvatarBaseError`](../interfaces/mw.AvatarBaseError.md) & `{ `assetId`: `string`  }`)[] |
