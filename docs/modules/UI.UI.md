...
| Enumerations |
| :-----|
| [ButtonClickMethod](../enums/UI.UI.ButtonClickMethod.md) <br> 按钮点击响应规则|
| [ButtonPressMethod](../enums/UI.UI.ButtonPressMethod.md) <br> 按钮按压响应规则|
| [ButtonTouchMethod](../enums/UI.UI.ButtonTouchMethod.md) <br> 按钮触摸响应规则|
| [CameraControlType](../enums/UI.UI.CameraControlType.md) <br> 相机控制模式|
| [DragPivot](../enums/UI.UI.DragPivot.md) <br> 拖拽的锚点|
| [InputTextLimit](../enums/UI.UI.InputTextLimit.md) <br> 输入框限制|
| [MaskType](../enums/UI.UI.MaskType.md) <br> 遮罩类型|
| [MouseLockMode](../enums/UI.UI.MouseLockMode.md) <br> 鼠标锁定模式|
| [Orientation](../enums/UI.UI.Orientation.md) <br> 滚动框类型|
| [ProgressBarFillType](../enums/UI.UI.ProgressBarFillType.md) <br> 进度条填充规则|
| [ScrollBarDefaultLocation](../enums/UI.UI.ScrollBarDefaultLocation.md) <br> 滚动条默认位置|
| [SlateBrushDrawType](../enums/UI.UI.SlateBrushDrawType.md) <br> 图片画刷绘制模式|
| [SlateBrushTileType](../enums/UI.UI.SlateBrushTileType.md) <br> 图片画刷填充模式|
| [SlateColorStylingMode](../enums/UI.UI.SlateColorStylingMode.md) <br> UI颜色应用模式|
| [SlateVisibility](../enums/UI.UI.SlateVisibility.md) <br> UI节点显示规则|
| [TextCommit](../enums/UI.UI.TextCommit.md) <br> 输入提交模式|
| [TextJustify](../enums/UI.UI.TextJustify.md) <br> 文本排列对齐规则|
| [TextVerticalJustify](../enums/UI.UI.TextVerticalJustify.md) <br> 文本排列垂直对齐规则|
| [UIConstraintHorizontal](../enums/UI.UI.UIConstraintHorizontal.md) <br> 对齐策略水平规则|
| [UIConstraintVertical](../enums/UI.UI.UIConstraintVertical.md) <br> 对齐策略垂直规则|
| [UIFontGlyph](../enums/UI.UI.UIFontGlyph.md) <br> 字体类型|
| [UIHorizontalCollation](../enums/UI.UI.UIHorizontalCollation.md) <br> 自动布局子项布局排序 - 水平排序|
| [UIHugContentHorizontally](../enums/UI.UI.UIHugContentHorizontally.md) <br> 自动布局容器水平适应规则|
| [UIHugContentVertically](../enums/UI.UI.UIHugContentVertically.md) <br> 自动布局容器垂直适应规则|
| [UILayoutPacket](../enums/UI.UI.UILayoutPacket.md) <br> 自动布局节点排列规则|
| [UILayoutType](../enums/UI.UI.UILayoutType.md) <br> 自动布局排版规则|
| [UIScrollBoxAnimationType](../enums/UI.UI.UIScrollBoxAnimationType.md) <br> 滚动框动画类型|
| [UITextHorizontalLayout](../enums/UI.UI.UITextHorizontalLayout.md) <br> 文本框规则显示规则限制|
| [UIVerticalCollation](../enums/UI.UI.UIVerticalCollation.md) <br> 自动布局子项布局排序 - 垂直排序|

| Classes |
| :-----|
| [AnalogInputEvent](../classes/UI.UI.AnalogInputEvent.md) <br> 轴输入事件|
| [AssetIconData](../classes/UI.UI.AssetIconData.md) <br> 资源ICON信息|
| [Button](../classes/UI.UI.Button.md) <br> 按钮,无默认text|
| [Canvas](../classes/UI.UI.Canvas.md) <br> 可挂载叶子节点的根节点，以及提供各种自动布局功能|
| [CharacterEvent](../classes/UI.UI.CharacterEvent.md) <br> 角色输入事件|
| [ColorPick](../classes/UI.UI.ColorPick.md) <br> 颜色选择器|
| [DragDropOperation](../classes/UI.UI.DragDropOperation.md) <br> UI 拖拽事件|
| [DragDropPayLoad](../classes/UI.UI.DragDropPayLoad.md) <br> 拖拽事件数据传递类|
| [EventReply](../classes/UI.UI.EventReply.md) <br> 事件回复|
| [FocusEvent](../classes/UI.UI.FocusEvent.md) <br> 焦点事件|
| [Geometry](../classes/UI.UI.Geometry.md) <br> 几何坐标信息|
| [Image](../classes/UI.UI.Image.md) <br> UI 图片|
| [InputBox](../classes/UI.UI.InputBox.md) <br> UI的输入框|
| [InputEvent](../classes/UI.UI.InputEvent.md) <br> 输入事件|
| [JoystickStyleDesigner](../classes/UI.UI.JoystickStyleDesigner.md) <br> 摇杆信息|
| [KeyEvent](../classes/UI.UI.KeyEvent.md) <br> 按键事件|
| [Margin](../classes/UI.UI.Margin.md) <br> 基础的边距，提供4个方向的数值修改|
| [PanelWidget](../classes/UI.UI.PanelWidget.md) <br> UI的PanelWidget可以挂载子节点|
| [PointerEvent](../classes/UI.UI.PointerEvent.md) <br> 点击或者滑动的时候传递mobile touch,鼠标,键盘信息的类|
| [ProgressBar](../classes/UI.UI.ProgressBar.md) <br> UI进度条|
| [ScrollBox](../classes/UI.UI.ScrollBox.md) <br> 滑动框|
| [SlateBrushWithGuid](../classes/UI.UI.SlateBrushWithGuid.md) <br> 贴图信息|
| [SlateColor](../classes/UI.UI.SlateColor.md) <br> UI颜色管理|
| [StaleButton](../classes/UI.UI.StaleButton.md) <br> 按钮|
| [TabGroup](../classes/UI.UI.TabGroup.md) <br> 选项卡组|
| [TextBlock](../classes/UI.UI.TextBlock.md) <br> UI文本|
| [TouchPad](../classes/UI.UI.TouchPad.md) <br> 摄像机滑动区|
| [UIBehavior](../classes/UI.UI.UIBehavior.md) <br> UI的驱动脚本基类|
| [UIChildCollation](../classes/UI.UI.UIChildCollation.md) <br> 容器自动布局子项排序规则|
| [UIConstraintAnchors](../classes/UI.UI.UIConstraintAnchors.md) <br> 节点对齐规则|
| [UIFontInfo](../classes/UI.UI.UIFontInfo.md) <br> 字体信息|
| [UIHugContent](../classes/UI.UI.UIHugContent.md) <br> 容器自动布局大小适应规则|
| [UILayout](../classes/UI.UI.UILayout.md) <br> 容器自动布局规则|
| [UIManager](../classes/UI.UI.UIManager.md) <br> UI管理类，可以继承此类，自带一个全局UI作为UI的总节点。|
| [UISlot](../classes/UI.UI.UISlot.md) <br> UI插槽|
| [UITransform](../classes/UI.UI.UITransform.md) <br> 节点Transform|
| [UserWidget](../classes/UI.UI.UserWidget.md) <br> UI控件的集合,预制体UI|
| [UserWidgetPrefab](../classes/UI.UI.UserWidgetPrefab.md) <br> ui预制体|
...
| **[assetIDChangeIConUrlRequest](UI.UI.md#assetidchangeiconurlrequest)**(`string`[]): `Promise`<`void`\> <br> 异步请求资源的ICON信息|
| **[cancelDragDrop](UI.UI.md#canceldragdrop)**(): `void` <br> 中断所有的DragDrop|
| **[createUI](UI.UI.md#createui)**<extends [`UIBehavior`](../classes/UI.UI.UIBehavior.md)<`T`\> |\>(`string`, () => `T`): extends [`UIBehavior`](../classes/UI.UI.UIBehavior.md)<`T`\> | <br> 创建UIPrefab|
| **[createUIByName](UI.UI.md#createuibyname)**(`string`): [`UserWidget`](../classes/UI.UI.UserWidget.md) <br> 创建UIPrefab|
| **[createUIByPath](UI.UI.md#createuibypath)**(`string`): [`UserWidget`](../classes/UI.UI.UserWidget.md) <br> 创建UIPrefab|
| **[createUIOnlyClass](UI.UI.md#createuionlyclass)**<extends [`UIBehavior`](../classes/UI.UI.UIBehavior.md)<`T`\> |\>(() => `T`): extends [`UIBehavior`](../classes/UI.UI.UIBehavior.md)<`T`\> | <br> 创建空的UI|
| **[endDragDrop](UI.UI.md#enddragdrop)**([`EventReply`](../classes/UI.UI.EventReply.md)): `void` <br> 中断一个拖拽事件, 传入一个操作的事件|
| **[findUIBehavior](UI.UI.md#finduibehavior)**([`Widget`](../classes/UI.UI.Widget.md)): [`UIBehavior`](../classes/UI.UI.UIBehavior.md) <br> 获取UI脚本|
...
| **[getAssetIconDataByAssetID](UI.UI.md#getasseticondatabyassetid)**(`string`): [`AssetIconData`](../classes/UI.UI.AssetIconData.md) <br> 获取资源的ICON信息|
| **[getCurrentMousePosition](UI.UI.md#getcurrentmouseposition)**(): [`Vector2`](../classes/Type.Type.Vector2.md) <br> 获取当前鼠标所在的绝对位置|
| **[getDragDroppingContent](UI.UI.md#getdragdroppingcontent)**(): [`DragDropOperation`](../classes/UI.UI.DragDropOperation.md) <br> 获取当前的DragDrop事件|
...
| **[isUnderLocation](UI.UI.md#isunderlocation)**([`Geometry`](../classes/UI.UI.Geometry.md), [`Vector2`](../classes/Type.Type.Vector2.md)): `boolean` <br> 判定给定坐标是否在geometry下|
...
| **[screenToWidgetAbsolute](UI.UI.md#screentowidgetabsolute)**([`Vector2`](../classes/Type.Type.Vector2.md), `boolean`): [`Vector2`](../classes/Type.Type.Vector2.md) <br> 将屏幕位置(像素)转换为绝对桌面程序坐标。如果bIncludeWindowPosition为真，那么这个方法也将移除游戏窗口的位置(在窗口模式下有用)。|
| **[screenToWidgetLocal](UI.UI.md#screentowidgetlocal)**([`Geometry`](../classes/UI.UI.Geometry.md), [`Vector2`](../classes/Type.Type.Vector2.md), `boolean`): [`Vector2`](../classes/Type.Type.Vector2.md) <br> 将屏幕位置(以像素为单位)转换为具有给定几何形状的小部件的本地空间。如果bIncludeWindowPosition为真，那么这个方法也将移除游戏窗口的位置(在窗口模式下有用)。|
| **[setFocusToGameViewport](UI.UI.md#setfocustogameviewport)**(): `void` <br> 设置关注游戏窗口|
| **[setInputModeGameAndUI](UI.UI.md#setinputmodegameandui)**([`Widget`](../classes/UI.UI.Widget.md), [`MouseLockMode`](../enums/UI.UI.MouseLockMode.md), `boolean`): `void` <br> 设置一个输入模式，只允许UI响应用户输入，如果UI不处理它，玩家输入/玩家控制器就有机会|
| **[setInputModeGameOnly](UI.UI.md#setinputmodegameonly)**(): `void` <br> 设置一个输入模式，只允许玩家输入/玩家控制器响应用户输入|
| **[setInputModeUIOnly](UI.UI.md#setinputmodeuionly)**([`Widget`](../classes/UI.UI.Widget.md), [`MouseLockMode`](../enums/UI.UI.MouseLockMode.md)): `void` <br> 设置只允许UI响应用户输入的输入模式。|
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `UI` | [`Widget`](../classes/UI.UI.Widget.md) | UI控件 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `InWidgetToFocus?` | [`Widget`](../classes/UI.UI.Widget.md) | 响应输入模式的widget default:null |
