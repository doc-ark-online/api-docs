...
| Enumeration Members |
| :-----|
| **[A](Type.Keys.md#a)** = ``"[A](Type.Keys.md#a)"`` <br> A键|
| **[Add](Type.Keys.md#add)** = ``"[Add](Type.Keys.md#add)"`` <br> 小键盘+键位|
| **[AnyKey](Type.Keys.md#anykey)** = ``"[AnyKey](Type.Keys.md#anykey)"`` <br> 任意按键|
| **[B](Type.Keys.md#b)** = ``"[B](Type.Keys.md#b)"`` <br> B键|
| **[Backspace](Type.Keys.md#backspace)** = ``"BackSpace"`` <br> 退位键|
| **[C](Type.Keys.md#c)** = ``"[C](Type.Keys.md#c)"`` <br> C键|
| **[CapsLock](Type.Keys.md#capslock)** = ``"[CapsLock](Type.Keys.md#capslock)"`` <br> Caps键|
| **[Colon](Type.Keys.md#colon)** = ``"[Colon](Type.Keys.md#colon)"`` <br> :号|
| **[Comma](Type.Keys.md#comma)** = ``"[Comma](Type.Keys.md#comma)"`` <br> ,号|
| **[D](Type.Keys.md#d)** = ``"[D](Type.Keys.md#d)"`` <br> D键|
| **[Decimal](Type.Keys.md#decimal)** = ``"[Decimal](Type.Keys.md#decimal)"`` <br> 小键盘dec键位|
| **[Delete](Type.Keys.md#delete)** = ``"[Delete](Type.Keys.md#delete)"`` <br> Del键|
| **[Divide](Type.Keys.md#divide)** = ``"[Divide](Type.Keys.md#divide)"`` <br> 小键盘/键位|
| **[Dollar](Type.Keys.md#dollar)** = ``"[Dollar](Type.Keys.md#dollar)"`` <br> $号|
| **[Down](Type.Keys.md#down)** = ``"[Down](Type.Keys.md#down)"`` <br> ↓键|
| **[E](Type.Keys.md#e)** = ``"[E](Type.Keys.md#e)"`` <br> E键|
| **[Eight](Type.Keys.md#eight)** = ``"[Eight](Type.Keys.md#eight)"`` <br> 8键|
| **[End](Type.Keys.md#end)** = ``"[End](Type.Keys.md#end)"`` <br> End键|
| **[Enter](Type.Keys.md#enter)** = ``"[Enter](Type.Keys.md#enter)"`` <br> 回车键|
| **[Equals](Type.Keys.md#equals)** = ``"[Equals](Type.Keys.md#equals)"`` <br> =号|
| **[Escape](Type.Keys.md#escape)** = ``"[Escape](Type.Keys.md#escape)"`` <br> Esc键|
| **[Exclamation](Type.Keys.md#exclamation)** = ``"[Exclamation](Type.Keys.md#exclamation)"`` <br> !号|
| **[F](Type.Keys.md#f)** = ``"[F](Type.Keys.md#f)"`` <br> F键|
| **[F1](Type.Keys.md#f1)** = ``"[F1](Type.Keys.md#f1)"`` <br> F1键|
| **[F10](Type.Keys.md#f10)** = ``"[F10](Type.Keys.md#f10)"`` <br> F10键|
| **[F11](Type.Keys.md#f11)** = ``"[F11](Type.Keys.md#f11)"`` <br> F11键|
| **[F12](Type.Keys.md#f12)** = ``"[F12](Type.Keys.md#f12)"`` <br> F12键|
| **[F2](Type.Keys.md#f2)** = ``"[F2](Type.Keys.md#f2)"`` <br> F2键|
| **[F3](Type.Keys.md#f3)** = ``"[F3](Type.Keys.md#f3)"`` <br> F3键|
...
| **[NumPadFive](Type.Keys.md#numpadfive)** = ``"[NumPadFive](Type.Keys.md#numpadfive)"`` <br> 小键盘5键位|
...
| **[Tilde](Type.Keys.md#tilde)** = ``"[Tilde](Type.Keys.md#tilde)"`` <br> ~号|
